Shader "Universal Render Pipeline/GroundShader"
{
    Properties
    {
        ...
        _SaturationStrength("Saturation Strength",Float) = 0.8
        _GammaEffect("Gamma Effect",Float) = 0.8
...
struct Varyings
{
    ...
    float4 worldSpacePos : TEXCOORD9;
...
// Used in Standard (Physically Based) shader
        ...
        half4 LitPassFragment(Varyings input) : SV_Target
        {
            ...
            float _coolFactor = ceil(saturate(0.35 - _value)) * ceil(saturate(_value - 0.3)) * _CAvoid;
            ...
            _finalColor = (1 - _coolFactor) * _finalColor + _coolFactor * half3(20.0,20.0, 20.0);
